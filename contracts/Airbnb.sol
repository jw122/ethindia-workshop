...
contract Airbnb {
    ...
    // internal functions are prefixed with underscore. Won't want anyone to be able to send funds to their own account or create a booking on inactive property
    ...
    function _createBooking(
        ...
        // TODO: where is this bookingId coming from?
